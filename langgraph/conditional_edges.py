...
def router():
    ...
    def handle_command(state: RouterState) -> dict:
        return {"response": f"[Executing] I'll get back to you on this {state['query']}"}
    ...
    workflow.add_conditional_edges("classify", route_by_type, {"question": "handle_question", "command": "handle_command", "statement": "handle_statement"})
